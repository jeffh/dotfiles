...
exec "Snippet default <!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"\n\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\"><CR><html xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en\" lang=\"en\"><CR><head><CR><meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\" /><CR><title>".st.et."</title><CR>".st.et."<CR><BS></head><CR><body><CR>".st.et."<CR><BS></body><CR><BS></html>"
...
exec "Snippet script <script type=\"text/javascript\" charset=\"utf-8\"><CR><BS>// <![CDATA[<CR>".st.et."<CR>// ]]><CR><TAB><BS></script>".st.et
...
exec "Snippet scriptsrc <script src=\"".st.et."\" type=\"text/javascript\" charset=\"UTF-8\"></script>".st.et
